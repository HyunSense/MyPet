...
import com.shopping.mypet.service.MemberServiceV1;
...
//    @PostMapping("/login")
    public String loginPost(@ModelAttribute LoginForm loginForm, Model model) {
        ...
        Map<String, String> errors = memberServiceV1.loginMemberValidation(loginForm);
...
//    @PostMapping("/signup")
    public String signUpPostV1(@ModelAttribute SignUpForm signUpForm, Model model) {
        ...
        //검증 오류 결과를 보관
        Map<String, String> errors = memberServiceV1.signupMemberValidation(signUpForm);
